...
(defvar modus-australis-palette
  (modus-themes-generate-palette
   `(
     ...
     (bg-term-green           "#96B17F")
     (fg-term-green           "#96B17F")
     (bg-term-green-bright    "#96B17F")
     (fg-term-green-bright    "#96B17F")
     (bg-term-yellow          "#C5A565")
     (fg-term-yellow          "#C5A565")
     (bg-term-yellow-bright   "#C5A565")
     (fg-term-yellow-bright   "#C5A565")
     (bg-term-blue            "#81A1C1")
     (fg-term-blue            "#81A1C1")
     ...
     (bg-term-cyan            "#7BB3C3")
     (fg-term-cyan            "#7BB3C3")
     (bg-term-cyan-bright     "#82AFAE")
     (fg-term-cyan-bright     "#82AFAE")
     (bg-term-white           "#A5ABB6")
     (fg-term-white           "#A5ABB6")
