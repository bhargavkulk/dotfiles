...
(defvar modus-borealis-palette
  (modus-themes-generate-palette
   `(
     ...
     (bg-term-black-bright    "#000000")
     (fg-term-black-bright    "#000000")
     (bg-term-red             "#BF616A")
     (fg-term-red             "#BF616A")
     (bg-term-red-bright      "#BF616A")
     (fg-term-red-bright      "#BF616A")
     (bg-term-green           "#A3BE8C")
     (fg-term-green           "#A3BE8C")
     (bg-term-green-bright    "#A3BE8C")
     (fg-term-green-bright    "#A3BE8C")
     (bg-term-yellow          "#EBCB8B")
     (fg-term-yellow          "#EBCB8B")
     (bg-term-yellow-bright   "#EBCB8B")
     (fg-term-yellow-bright   "#EBCB8B")
     (bg-term-blue            "#81A1C1")
     (fg-term-blue            "#81A1C1")
     (bg-term-blue-bright     "#81A1C1")
     (fg-term-blue-bright     "#81A1C1")
     (bg-term-magenta         "#B48EAD")
     (fg-term-magenta         "#B48EAD")
     (bg-term-magenta-bright  "#B48EAD")
     (fg-term-magenta-bright  "#B48EAD")
     (bg-term-cyan            "#88C0D0")
     (fg-term-cyan            "#88C0D0")
     (bg-term-cyan-bright     "#8FBCBB")
     (fg-term-cyan-bright     "#8FBCBB")
     (bg-term-white           "#E5E9F0")
     (fg-term-white           "#E5E9F0")
